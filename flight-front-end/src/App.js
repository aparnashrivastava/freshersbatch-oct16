...
import Flight from "./components/flight-component/update-flight.component";
import DelFlight from "./components/flight-component/delete-booking.component";

import BookASeat from "./components/seat-component/book-seat.component";
import HandleFlightDetails from "./components/flight-component/handling-flight-details.component";

import TicketDetails from "./components/booking-component/ticket-generation.component";
        ...
        <div>
          <nav className="navbar navbar-expand navbar-dark bg-dark">
            <Link to={"/"} className="navbar-brand">
              Travel<b color="light green">O</b>Pedia
            </Link>
          ...
          <div className="container mt-3">
            <Switch>
              ...
              <Route path="/flight/:flightName" component={Flight} />
